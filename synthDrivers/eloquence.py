...
class SynthDriver(synthDriverHandler.SynthDriver):
 ...
 def xspeakText(self,text, should_pause=False):
  ...
  if len(text) > 1:
    ...
    text = text.replace("č", "cheh")
    text = text.replace("Č", "CHEH")
    text = text.replace("ć", "tjeh")
    text = text.replace("Ć", "Tjeh")
    text = text.replace("š", "sheh")
    text = text.replace("Š", "SHEH")
    text = text.replace("đ", "djeh")
    text = text.replace("Đ", "Djeh")
    text = text.replace("ž", "zheh")
    text = text.replace("Ž", "Zheh")
